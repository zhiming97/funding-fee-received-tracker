...
#Open your cryptocurrency exchange in google chrome
options = uc.ChromeOptions()
options.headless = False

browser = uc.Chrome(options=options, use_subprocess=True)

# Function to get to the funding history
...
credentials_path = 'Your Credentials JSON File'
...
# Open the Google Sheet by Google Sheet ID
